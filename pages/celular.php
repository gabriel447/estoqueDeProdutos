<section class="corpoChecklistTecnico">
    <form method="post">
        <div>
            ...
            <input name="carga" type="checkbox" value="yes" <?php if ($carga != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input name="google" type="checkbox" value="yes" <?php if ($google != '') {
                                                                    echo 'checked';
                                                                } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input name="rom" type="checkbox" value="yes" <?php if ($rom != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input name="app" type="checkbox" value="yes" <?php if ($app != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input name="stress" type="checkbox" value="yes" <?php if ($stress != '') {
                                                                    echo 'checked';
                                                                } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input name="chip" type="checkbox" value="yes" <?php if ($chip != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
