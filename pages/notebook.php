<section class="corpoChecklistTecnico">
    <form method="post">
        <div>
            ...
            <input type="checkbox" name="carga" value="yes" <?php if ($carga != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="monitor" value="yes" <?php if ($monitor != '') {
                                                                    echo 'checked';
                                                                } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="ram" value="yes" <?php if ($ram != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="linux" value="yes" <?php if ($linux != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="bios" value="yes" <?php if ($bios != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="pasta" value="yes" <?php if ($pasta != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="hd" value="yes" <?php if ($hd != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="chave" value="yes" <?php if ($chave != '') {
                                                                echo 'checked';
                                                            } ?>> sim
            <br>
        </div>
        <div>
            ...
            <input type="checkbox" name="bateria" value="yes" <?php if ($bateria != '') {
                                                                    echo 'checked';
                                                                } ?>> sim
            <br>
        </div>
